...
// When instantiating something for the first time, use the keyword "new"
let day = new Date().getDay();

console.log(day) // This is a number based on the number of the date within the week. Starts from 0
...
switch(day){
    ...
    case 1:
        ...
        break;
    case 2: // Because today is Tuesday, the day value = 2 which renders this case.
...
console.log(literal_day.split(" ")[0])//Evals to 'Tue' which will run the Tue case
...
// -- Creation of Objects in JavaScript; similar to python dictionaries
...
console.log(person['fav_color'])// Bracket Notation
console.log(person.name) 
console.log(person.age)
...
console.log(Object.keys(person2)) // Get the keys of your object
console.log(Object.values(person2)) // Get the values of your object
...
function Car(make,model,year){
    ...
    this.printInfo = function(wheels = 0, color){
        ...
        and has ${wheels} wheels and the color is ${color}`);
